...
- [**External prerequisites**](docs/prerequisites.md) — the load-bearing dependencies CROA consumes but doesn't provide: agent identity (still unstandardized) and a sufficiently complete Federated Context Registry.
