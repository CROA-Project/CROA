<!-- Thanks for contributing to CROA. Keep PRs focused: one concern each. -->
...
- [ ] Editorial (typo, formatting, links) — no meaning change
- [ ] Clarification — clearer wording, **no requirement changes**
- [ ] Documentation / ecosystem (docs, public-review, evidence, governance text)
- [ ] Reference-harness or tooling change
...
<!-- editorial | clarification | normative-correction | normative-change | extension -->
<!-- Normative correction/change/extension require an accepted RFC. -->

## Linked items

- Closes / relates to issue: #
- Implements RFC: #
- Related research question(s): RQ-
