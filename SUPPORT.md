...
CROA is a Public Review Draft, maintained in the open. Here is where to go for each kind of question,
...
| Report a security issue in the harness or tooling | See [`SECURITY.md`](SECURITY.md) — do not open a public issue first. |
| Something about conduct | [`CODE_OF_CONDUCT.md`](CODE_OF_CONDUCT.md). |

There is no paid support and no SLA — this is a public review. Maintainers respond in the open, on a
best-effort basis, and commit to acknowledging every well-formed finding (see [`GOVERNANCE.md`](GOVERNANCE.md)).
When in doubt, open a Discussion and we'll route it.
